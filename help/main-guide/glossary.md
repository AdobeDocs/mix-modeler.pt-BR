...
| **Dados agregados ou de resumo** | Dados de alto nível, detalhando como um grupo (por exemplo, consumidores, campanhas, regiões etc.) O interage com o ou executa o em sua empresa |
