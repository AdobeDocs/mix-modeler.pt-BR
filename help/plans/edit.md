...
Para editar um plano, na ![PLan](/help/assets//icons/FileChart.svg) **[!UICONTROL Plans]** em Mix Modeler, selecione seu plano pelo nome.
...
1. Para baixar um arquivo CSV com os dados do detalhamento de Intervalo de datas, selecione ![Baixar](/help/assets//icons/Download.svg) **[!UICONTROL Download CSV]**. No menu de contexto:

   - Selecionar ![Baixar](/help/assets//icons/Download.svg) **[!UICONTROL Detailed CSV]** para obter dados detalhados em formato CSV.
   - Selecionar ![Baixar](/help/assets//icons/Download.svg) **[!UICONTROL Summary CSV]** para obter dados de resumo em formato CSV.
...
1. Para editar o plano, selecione **[!UICONTROL Edit plan]**:
   ...
   1. No **[!UICONTROL Spend selection]** para cada intervalo de datas do orçamento, use o ![Divisa](/help/assets//icons/ChevronRight.svg) para abrir a exibição de distribuição de canal para esse intervalo de dados.
   ...
   1. Para alternar entre entrada de moeda ou porcentagem, selecione **[!UICONTROL $]** ou **[!UICONTROL %]** para **[!UICONTROL View spend by]**.
      ...
      ![Seleção de gastos](/help/assets//spend-selection.png)
   ...
   1. Para editar os detalhes do seu plano, selecione **[!UICONTROL Edit details]**:
      ...
      1. No **[!UICONTROL Budget]** seção:
         ...
         1. Modifique o **[!UICONTROL Date range]** para um ou mais intervalos de datas do seu plano, digitando datas ou selecionando um intervalo de datas usando ![Calendário](/help/assets//icons/Calendar.svg).
